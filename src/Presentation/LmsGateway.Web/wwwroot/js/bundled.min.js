 ...
 * License: MIT
 */
!function(n,t,i){"use strict";n.fn.scrollUp=function(t){n.data(i.body,"scrollUp")||(n.data(i.body,"scrollUp",!0),n.fn.scrollUp.init(t))};n.fn.scrollUp.init=function(r){var o,s,e,l,a,h,f,u=n.fn.scrollUp.settings=n.extend({},n.fn.scrollUp.defaults,r),c=!1;switch(f=u.scrollTrigger?n(u.scrollTrigger):n("<a/>",{id:u.scrollName,href:"#top"}),u.scrollTitle&&f.attr("title",u.scrollTitle),f.appendTo("body"),u.scrollImg||u.scrollTrigger||f.html(u.scrollText),f.css({display:"none",position:"fixed",zIndex:u.zIndex}),u.activeOverlay&&n("<div/>",{id:u.scrollName+"-active"}).css({position:"absolute",top:u.scrollDistance+"px",width:"100%",borderTop:"1px dotted"+u.activeOverlay,zIndex:u.zIndex}).appendTo("body"),u.animation){case"fade":o="fadeIn";s="fadeOut";e=u.animationSpeed;break;case"slide":o="slideDown";s="slideUp";e=u.animationSpeed;break;default:o="show";s="hide";e=0}l="top"===u.scrollFrom?u.scrollDistance:n(i).height()-n(t).height()-u.scrollDistance;a=n(t).scroll(function(){n(t).scrollTop()>l?c||(f[o](e),c=!0):c&&(f[s](e),c=!1)});u.scrollTarget?"number"==typeof u.scrollTarget?h=u.scrollTarget:"string"==typeof u.scrollTarget&&(h=Math.floor(n(u.scrollTarget).offset().top)):h=0;f.click(function(t){t.preventDefault();n("html, body").animate({scrollTop:h},u.scrollSpeed,u.easingType)})};n.fn.scrollUp.defaults={scrollName:"scrollUp",scrollDistance:300,scrollFrom:"top",scrollSpeed:300,easingType:"linear",animation:"fade",animationSpeed:200,scrollTrigger:!1,scrollTarget:!1,scrollText:"Scroll to top",scrollTitle:!1,scrollImg:!1,activeOverlay:!1,zIndex:2147483647};n.fn.scrollUp.destroy=function(r){n.removeData(i.body,"scrollUp");n("#"+n.fn.scrollUp.settings.scrollName).remove();n("#"+n.fn.scrollUp.settings.scrollName+"-active").remove();n.fn.jquery.split(".")[1]>=7?n(t).off("scroll",r):n(t).unbind("scroll",r)};n.scrollUp=n.fn.scrollUp}(jQuery,window,document),function(n){"use strict";n(document).on("ready",function(){jQuery(window).on("scroll",function(){n(this).scrollTop()>100?n(".header").addClass("sticky"):n(".header").removeClass("sticky")});n(".menu").slicknav({prependTo:".mobile-menu",duration:600,closeOnClick:!0});n(".slider-active").owlCarousel({autoplay:!0,autoplayTimeout:3500,autoplayHoverPause:!0,items:1,smartSpeed:600,loop:!0,merge:!0,nav:!0,dots:!1,navText:['<i class="fa fa-angle-left" aria-hidden="true"><\/i>','<i class="fa fa-angle-right" aria-hidden="true"><\/i>'],responsive:{300:{nav:!1},768:{nav:!1},1170:{nav:!0}}});n(".circle").circleProgress({fill:{color:"#00B16A"}});n(".course-slider").owlCarousel({items:3,autoplay:!0,autoplayTimeout:3500,smartSpeed:600,autoplayHoverPause:!0,margin:25,loop:!0,merge:!0,dots:!1,nav:!0,navText:['<i class="fa fa-angle-left" aria-hidden="true"><\/i>','<i class="fa fa-angle-right" aria-hidden="true"><\/i>'],responsive:{300:{items:1,nav:!1},480:{items:2,nav:!1},768:{items:2,nav:!1},1170:{items:3}}});n(".testimonial-slider").owlCarousel({autoplay:!0,autoplayTimeout:3500,smartSpeed:600,autoplayHoverPause:!0,margin:25,loop:!0,merge:!0,center:!1,nav:!0,dots:!1,navText:['<i class="fa fa-angle-left" aria-hidden="true"><\/i>','<i class="fa fa-angle-right" aria-hidden="true"><\/i>'],responsive:{300:{items:1,nav:!1},480:{items:2,nav:!1},768:{items:2,nav:!1},1170:{items:2}}});n(".event-slider").owlCarousel({autoplay:!0,autoplayTimeout:3500,smartSpeed:600,autoplayHoverPause:!0,margin:25,loop:!0,merge:!0,nav:!0,dots:!1,navText:['<i class="fa fa-angle-left" aria-hidden="true"><\/i>','<i class="fa fa-angle-right" aria-hidden="true"><\/i>'],responsive:{300:{items:1,nav:!1},480:{items:2,nav:!1},768:{items:2,nav:!1},1170:{items:3}}});n(".event-gallery").owlCarousel({items:1,autoplay:!1,autoplayTimeout:3500,smartSpeed:600,autoplayHoverPause:!0,animateOut:"fadeOut",animateIn:"fadeIn",margin:0,loop:!0,merge:!0,nav:!0,navText:['<i class="fa fa-angle-left" aria-hidden="true"><\/i>','<i class="fa fa-angle-right" aria-hidden="true"><\/i>'],dots:!1});n(".counter").counterUp({delay:10,time:4e3});n(".blog-slider").owlCarousel({items:2,autoplay:!1,autoplayTimeout:3500,smartSpeed:600,autoplayHoverPause:!0,margin:15,loop:!0,merge:!0,nav:!0,navText:['<i class="fa fa-angle-left" aria-hidden="true"><\/i>','<i class="fa fa-angle-right" aria-hidden="true"><\/i>'],dots:!0,responsive:{300:{items:1,nav:!1},480:{items:2,nav:!1},768:{items:2,nav:!1},1170:{items:3}}});n(".b-gallery").owlCarousel({items:1,autoplay:!1,autoplayTimeout:3500,smartSpeed:600,autoplayHoverPause:!0,animateOut:"fadeOut",animateIn:"fadeIn",margin:0,fade:!0,loop:!0,merge:!0,nav:!0,navText:['<i class="fa fa-angle-left" aria-hidden="true"><\/i>','<i class="fa fa-angle-right" aria-hidden="true"><\/i>'],dots:!1});n(".panel").on("click",function(){n(".panel").removeClass("active");n(this).addClass("active")});n(".video-popup").magnificPopup({type:"iframe",removalDelay:300,mainClass:"mfp-fade"});n(".masonry").masonry({itemSelector:".grid-item"});n(window).stellar({responsive:!0,positionProperty:"position",horizontalOffset:0,verticalOffset:0,horizontalScrolling:!1});var t=n(window).width();t>767&&(new WOW).init();n.scrollUp({scrollName:"scrollUp",scrollDistance:300,scrollFrom:"top",scrollSpeed:1e3,animation:"fade",animationSpeed:200,scrollTrigger:!1,scrollTarget:!1,easing:"easeInOutQuart",scrollText:["<i class='fa fa-angle-up'><\/i>"],scrollTitle:!1,scrollImg:!1,activeOverlay:!1,zIndex:2147483647})});n(window).on("load",function(){n(".book_preload").fadeOut("slow",function(){n(this).remove()})})}(jQuery);$(document).ready(function(){var n=window.location.pathname.toString().split("/").pop();switch(n.toLowerCase()){case"/":case"index":UpdateLinkState("active","","","","");break;case"about":UpdateLinkState("","active","","","");break;case"courses":UpdateLinkState("","","active","","","");break;case"events":UpdateLinkState("","","","active","","");break;case"contact":UpdateLinkState("","","","","active");break;default:UpdateLinkState("active","","","","")}});